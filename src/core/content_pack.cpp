...
const std::array<RequiredEntry, 10> award_required{{
    {"front-end.asset.059", 32, "82e0feac9f2c51e77d24ffc0d0a85d1fa8527fb09d7e88ec8aca140ede4b1de1"},
    ...
    {"front-end.asset.085", 32, "57c4633c161065fc610ce15709d256ddca057e6f18f11a29c392f7bbabd9d70d"},
    {"front-end.asset.086", 32, "bf5544921d9c456a0d17eb202cdf74b35d55220dd662ffede97242d880ba6148"},
...
// RACE-RIDERS-OPPONENTS (profile v21): what a one-player race takes from its pairing
// (tools/unirally_lab/content/front_end.py v21_new_entries, R-0061).
const std::array<RequiredEntry, 2> race_pairing_required{{
    {"race.opponent-catch-up", 45,
     "714361950a0117a377bf0202b0b23dd53ec1345540169fbf58432f5b23213134"},
