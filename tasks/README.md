...
| TRACK-BREADTH | in progress: part 1 (inventory, producers, playfield shapes, native idle matrix) reviewed and integrated by pull request; reference and match columns next | [Every track through the shared engine, measured against the original](TRACK-BREADTH.md) |
