...
| ZOOM-ZOO-WINDOW-EFFECTS | review (implementation `11d50f6` and `49bd26c`; local gates passed; independent review pending) | [ZOOM ZOO's windows from the original's selection](ZOOM-ZOO-WINDOW-EFFECTS.md) |
