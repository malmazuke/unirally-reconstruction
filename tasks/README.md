...
| TRACK-BREADTH | in progress: parts 1-3 reviewed and integrated by pull request (inventory and producers; references for the 20 reachable tracks; native selection of the 16 reachable race tracks by id, pack v10); next the guarded branches and the locked tours | [Every track through the shared engine, measured against the original](TRACK-BREADTH.md) |
