...
| NATIVE-READABILITY | ready; next (user request, 25 September 2026), before RESULT-TITLE-GLYPHS | [Make the recovered native code read as game code](NATIVE-READABILITY.md) |
