...
| TRACK-BREADTH | ready (STATIC-CODE-MAP integrated); the 45-stream inventory is in the record | [Every track through the shared engine, measured against the original](TRACK-BREADTH.md) |
| PR-WORKFLOW | in review; changes reach `main` only through pull requests, checks run on pull requests (user request, 23 September 2026), tier 2 | [Changes reach main through pull requests](PR-WORKFLOW.md) |
