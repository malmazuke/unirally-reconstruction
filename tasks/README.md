...
| TRACK-BREADTH | in progress: parts 1 and 2 reviewed and integrated by pull request (inventory, producers, shapes, idle matrix; references for the 20 reachable tracks, 6 exact over about 1,500 released-controller updates); native selection by track id next | [Every track through the shared engine, measured against the original](TRACK-BREADTH.md) |
